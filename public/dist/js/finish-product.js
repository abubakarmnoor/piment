...
$(document).ready(function() {
    ...
    table = $('#dtTbl').DataTable({
        ...
        "columns": [
            ...
            { "data": "fp_box_size_h" },
            { "data": "origin_desc" },
            { "data": "fp_sc_wholesale_sale", render: $.fn.dataTable.render.number(',', '.', 0, '')},
            { "data": "fp_sc_business_sale", render: $.fn.dataTable.render.number(',', '.', 0, '')},
            { "data": "fp_sc_retail_sale", render: $.fn.dataTable.render.number(',', '.', 0, '')},
            { "data": "fp_validated" },
            { "data": "fp_active" },
            { "data": "fp_upd_by" },
            { "data": "fp_upd_date" }
